...
class TextBox(AxesWidget):
    ...
    def _make_text_disp(self, string):
        return self.ax.text(self.DIST_FROM_LEFT,
                            0.5,
                            string,
                            verticalalignment='center',
                            horizontalalignment='left',
...
class SubplotTool(Widget):
    ...
    def __init__(self, targetfig, toolfig):
        ...
        *toolfig*
        ...
        self.sliderleft = Slider(self.axleft,
                                 'left',
                                 0,
                                 1,
                                 targetfig.subplotpars.left,
                                 closedmax=False)
        ...
        self.sliderright = Slider(self.axright,
                                  'right',
                                  0,
                                  1,
        ...
        self.slidertop = Slider(self.axtop,
                                'top',
                                0,
                                1,
        ...
        self.sliderwspace = Slider(self.axwspace,
                                   'wspace',
                                   0,
                                   1,
                                   targetfig.subplotpars.wspace,
                                   closedmax=False)
        self.sliderwspace.on_changed(self.funcwspace)

        self.axhspace = toolfig.add_subplot(716)
        self.axhspace.set_navigate(False)
        self.sliderhspace = Slider(self.axhspace,
                                   'hspace',
                                   0,
                                   1,
                                   targetfig.subplotpars.hspace,
                                   closedmax=False)
...
class RectangleSelector(_SelectorWidget):
    ...
    def _onmove(self, event):
        ...
        # new shape
            ...
            x1, x2, y1, y2 = (center[0] - dx, center[0] + dx, center[1] - dy,
                              center[1] + dy)
...
class PolygonSelector(_SelectorWidget):
    ...
    def _draw_polygon(self):
        ...
        # vertex.
        if (self._polygon_completed
                or (len(self._xs) > 3 and self._xs[-1] == self._xs[0]
                    and self._ys[-1] == self._ys[0])):
